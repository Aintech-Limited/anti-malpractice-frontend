...
import { ICreateExamPayload } from "../interface";
import { ICreateExamModalProps } from "./interface";
import { EXAM_TYPES } from "../utils/examConstants";
...
export const CreateExamModal = ({
  ...
  onClose,
  onSuccess,
}: ICreateExamModalProps) => {
  const [loading, setLoading] = useState(false);
  const [error, setError] = useState("");
  const [formData, setFormData] = useState<ICreateExamPayload>({
    courseId: "",
    title: "",
