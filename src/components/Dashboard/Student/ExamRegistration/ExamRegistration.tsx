...
export default function ExamRegistration({
  ...
  const handleRegisterLater = async (
    ...
    const examRegistrationId = await registerExam({ examId, level, semester });
    if (examRegistrationId) {
      updateExamRegistrationStatus(examId, false, examRegistrationId);
  ...
  const handleRegisterAndPay = async (
    ...
    if (examRegistrationId) {
      updateExamRegistrationStatus(examId, false, examRegistrationId);
      toast.info("Processing registration. Please wait");
      const paymentLink = await initiatePayment(examRegistrationId);
      if (paymentLink) {
