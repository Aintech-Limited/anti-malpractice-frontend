...
export default function Payments({
  ...
  return (
    <div className="min-h-screen bg-linear-to-br from-gray-50 to-gray-100 max-w-full mx-auto">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="mb-8">
          <h1 className="text-4xl font-bold bg-linear-to-r from-indigo-600 to-purple-600 bg-clip-text text-transparent whitespace-break-spaces">
            Payment Dashboard
          </h1>
