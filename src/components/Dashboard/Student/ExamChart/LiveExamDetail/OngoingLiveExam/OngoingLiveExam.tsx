...
const OngoingLiveExam = ({
	...
	useEffect(() => {
		...
		const initializeProctoring = async () => {
			try {
				...
				toast.error(
					`Proctoring system failed to start. Please contact support. Error: ${JSON.stringify(err)}`,
				);
			}
		};
	...
	// TODO: Periodically sync answers to backend.
	...
	if (isSubmitted) {
		return (
			<ExamSummary
				// questions={
				// 	examType === ExamQuestionTypeEnum.MCQ
				// 		? questions.filter((q) => q.type === ExamQuestionTypeEnum.MCQ)
...
const data = {
	message: 'Live Exam Questions and Options retrieved successfully',
	success: true,
	data: [
		{
			id: '019da1a5-9fbb-734c-b39e-8015da470f95',
			examId: '019da116-63ae-721d-a49e-96a88e19b6fe',
			...
			options: [
				{
					id: '019da1a5-a0ea-7566-a598-f9017171b7d3',
					optionText: 'A',
					displayOrder: 1,
				},
				{
					id: '019da1a5-a0ea-7566-a598-f902201238f1',
					optionText: 'C',
					displayOrder: 2,
				},
				{
					id: '019da1a5-a0ea-7566-a598-f903b656e929',
					optionText: 'W',
					displayOrder: 3,
				},
				{
					id: '019da1a5-a0ea-7566-a598-f904edeaa45e',
					optionText: 'N',
					displayOrder: 4,
				},
			],
			attemptId: '019e6b51-6e11-7b55-9797-13803c31e4a6',
		},
		{
			id: '019da1a6-1035-79e2-adac-bb2ea271a585',
			examId: '019da116-63ae-721d-a49e-96a88e19b6fe',
			...
			options: [
				{
					id: '019da1a6-1135-7e49-ad6d-11ff5e578132',
					optionText: 'A',
					displayOrder: 1,
				},
				{
					id: '019da1a6-1135-7e49-ad6d-120080eed5e9',
					optionText: 'C',
					displayOrder: 2,
				},
				{
					id: '019da1a6-1135-7e49-ad6d-120156a1620e',
					optionText: 'B',
					displayOrder: 3,
				},
				{
					id: '019da1a6-1135-7e49-ad6d-120296cd48ac',
					optionText: 'N',
					displayOrder: 4,
				},
			],
		...
		{
			id: '019da1a6-b64a-71f2-80e6-b8449b271e4a',
			examId: '019da116-63ae-721d-a49e-96a88e19b6fe',
			questionText: 'What is the Third letter of the alphabet?',
			type: 'MCQ',
			marks: 10,
			displayOrder: 3,
			options: [
				{
					id: '019da1a6-b74c-7344-a42d-d67faa9a2f0a',
					optionText: 'A',
					displayOrder: 1,
				},
				{
					id: '019da1a6-b74c-7344-a42d-d680fc4d8c8d',
					optionText: 'C',
					displayOrder: 2,
				},
				{
					id: '019da1a6-b74c-7344-a42d-d6816ac7aec9',
					optionText: 'D',
					displayOrder: 3,
				},
				{
					id: '019da1a6-b74d-7ae1-a616-e277f622bf23',
					optionText: 'N',
					displayOrder: 4,
				},
			],
		...
		{
			id: '019da1a6-b64b-798a-b1ab-d6ba5c040fe6',
			examId: '019da116-63ae-721d-a49e-96a88e19b6fe',
			questionText: 'What is the Fourth letter of the alphabet?',
			type: 'MCQ',
			marks: 10,
			displayOrder: 4,
			options: [
				{
					id: '019da1a6-b74d-7ae1-a616-e278063cee93',
					optionText: 'D',
					displayOrder: 1,
				},
				{
					id: '019da1a6-b74d-7ae1-a616-e279b5cae51c',
					optionText: 'E',
					displayOrder: 2,
				},
				{
					id: '019da1a6-b74d-7ae1-a616-e27a2566109e',
					optionText: 'A',
					displayOrder: 3,
				},
				{
					id: '019da1a6-b74d-7ae1-a616-e27baa978138',
					optionText: 'F',
					displayOrder: 4,
				},
			],
