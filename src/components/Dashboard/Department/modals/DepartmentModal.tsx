...
export const DepartmentModal = ({
	...
	return (
		<div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 animate-fadeIn p-4 overflow-y-auto">
			<div className="bg-white rounded-2xl max-w-4xl w-full max-h-[90vh] overflow-y-auto transform transition-all animate-slideUp">
				{/* Hero Image */}
						...
						<>
							...
							<div className="grid md:grid-cols-2 gap-6 mb-8">
								<div className="bg-blue-50 rounded-xl p-5">
									...
									<p className="text-gray-600 text-sm">{stats.vision}</p>
								</div>
								<div className="bg-green-50 rounded-xl p-5">
									...
									<p className="text-gray-600 text-sm">{stats.mission}</p>
								</div>
							</div>
							...
							<div className="border-t border-gray-200 pt-6 mb-6">
								...
								<div className="grid md:grid-cols-2 gap-4">
									<div className="flex items-center gap-3">
										...
										<span className="text-gray-600">{stats.location}</span>
									</div>
									<div className="flex items-center gap-3">
										<Mail className="w-5 h-5 text-gray-400" />
										<span className="text-gray-600">{stats.email}</span>
									</div>
									<div className="flex items-center gap-3">
										<Phone className="w-5 h-5 text-gray-400" />
										<span className="text-gray-600">{stats.phone}</span>
									</div>
									<div className="flex items-center gap-3">
										<Calendar className="w-5 h-5 text-gray-400" />
										<span className="text-gray-600">
											Est. {stats.established}
										</span>
									</div>
								</div>
							</div>
