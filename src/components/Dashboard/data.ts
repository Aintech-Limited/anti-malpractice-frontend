...
export const StudentNavGroups: INavGroup[] = [
  ...
  },
  {
    ...
    path: "/complaints",
    children: [
      { name: "View Complaints", path: "/all" },
      { name: "Add Complaint", path: "" },
    ],
  },
  {
    name: "Finance",
...
export const VendorNavGroups: INavGroup[] = [
  { name: "Dashboard", icon: HouseIcon, path: "", children: [] },
  {
    name: "Books",
    icon: BookOpen,
...
export const AdminNavGroups: INavGroup[] = [
  ...
  { name: "Institutions", icon: School, path: "/institutions", children: [] },
  { name: "Vendors", icon: FileSignalIcon, path: "/vendors", children: [] },
